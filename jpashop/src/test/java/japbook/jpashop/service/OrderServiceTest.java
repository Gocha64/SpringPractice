...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        assertEquals("주문 수량만큼 재고가 줄어야한다.", 8, book.getStockQuantitiy());
    }
    ...
    public void 주문취소() throws Exception{
        ...
        assertEquals("주문이 취소된 상품은 그만큼 재고가 증가해야 한다.", 10, item.getStockQuantitiy());
    }
    ...
    private Book createBook(String name, int price, int quantity){
        ...
        book.setName(name);
        book.setPrice(price);
        book.setStockQuantitiy(quantity);
        em.persist(book);
        return book;
    }
